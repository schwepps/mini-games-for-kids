  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative flex flex-col-reverse items-center">
        {/* Base Platform */}
        <motion.div
          className={`w-24 sm:w-28 md:w-40 lg:w-48 h-6 sm:h-7 md:h-10 lg:h-12 ${getBaseStyle()} rounded-xl shadow-lg border-4 border-white/30 cursor-pointer transition-all duration-200 relative ${
            canReceiveDisc ? 'ring-4 ring-yellow-400 ring-opacity-75' : ''
          } ${
          ...
          whileTap={{ scale: 0.95 }}
          animate={{
            scale: canReceiveDisc ? [1, 1.04, 1] : 1,
        ...
        >
          {/* Click indicator when can receive disc */}
          {canReceiveDisc && (
            <motion.div
